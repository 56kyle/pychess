...
KING_SIDE_CASTLE_PATH = Path(offset=RIGHT * 2, max_steps=1, allowed_path_types=AllowedPathTypes.MOVE_ONLY)
QUEEN_SIDE_CASTLE_PATH = Path(offset=LEFT * 3, max_steps=1, allowed_path_types=AllowedPathTypes.MOVE_ONLY)
