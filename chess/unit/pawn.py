...
WHITE_PAWN_FIRST_PATH = Path(offset=UP * 2, max_steps=1, allowed_path_types=AllowedPathTypes.MOVE_ONLY)
WHITE_PAWN_STANDARD_PATH = Path(offset=UP, max_steps=1, allowed_path_types=AllowedPathTypes.MOVE_ONLY)
WHITE_PAWN_CAPTURE_PATHS = {
    Path(
        offset=offset,
        max_steps=1,
        allowed_path_types=AllowedPathTypes.CAPTURE_ONLY,
    ) for offset in {UP_RIGHT, UP_LEFT}
}
WHITE_PAWN_PATHS = {WHITE_PAWN_FIRST_PATH, WHITE_PAWN_STANDARD_PATH} | WHITE_PAWN_CAPTURE_PATHS

BLACK_PAWN_FIRST_PATH = Path(offset=DOWN * 2, max_steps=1, allowed_path_types=AllowedPathTypes.MOVE_ONLY)
BLACK_PAWN_STANDARD_PATH = Path(offset=DOWN, max_steps=1, allowed_path_types=AllowedPathTypes.MOVE_ONLY)
